...
# Generating some random cards for customers

RAW_PATH = r"data\data_gen"
NUM_CARDS = len(load_from_json(RAW_PATH, "customer_data.json"))
...
def generate_cards(output_length: int):
    ...
    save_to_json(RAW_PATH, "customer_cards.json", cards)

generate_cards(NUM_CARDS)